...
namespace Eve.Api.Api
{
    ...
    public partial class ContactsApi : IContactsApi
    {
        ...
        public ApiResponse<Object> DeleteCharactersCharacterIdContactsWithHttpInfo (int? characterId, List<int?> contactIds, string datasource = null, string token = null)
        {
            ...
            if (contactIds != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("csv", "contact_ids", contactIds)); // query parameter
        ...
        public ApiResponse< List<int?> > PostCharactersCharacterIdContactsWithHttpInfo (int? characterId, List<int?> contactIds, float? standing, string datasource = null, List<long?> labelIds = null, string token = null, bool? watched = null)
        {
            ...
            if (characterId != null) localVarPathParams.Add("character_id", Configuration.ApiClient.ParameterToString(characterId)); // path parameter
            if (datasource != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "datasource", datasource)); // query parameter
            if (labelIds != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("csv", "label_ids", labelIds)); // query parameter
